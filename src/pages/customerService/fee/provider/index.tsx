...
import { providerFeeColumns } from '@/pages/configurify/columns';
import AddModal from './components/AddModal';
import type { RefAddModalProps } from './components/AddModal';

const columns = _values(providerFeeColumns);

const ProviderFeeIndex: React.FC = () => {
...
export default ProviderFeeIndex;
